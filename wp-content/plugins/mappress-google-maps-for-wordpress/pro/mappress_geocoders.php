...
class Mappress_Geocoders {
	...
	*/
	function google($address) {
		// Use http instead of https to avoid CURL errors (https://core.trac.wordpress.org/ticket/25716)
		$url = "http://maps.googleapis.com/maps/api/geocode/json?address=$address&sensor=false&output=json";
